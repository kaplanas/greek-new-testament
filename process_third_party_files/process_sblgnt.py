...
SECOND_POSITION_CLITICS = ['ἄρα', 'γάρ', 'γε', 'δέ', 'μέν', 'μέντοι', 'οὖν', 'τέ']
...
INFINITIVE_ARGUMENT_HEADS = ['ἀγωνίζομαι', 'αἰτέω', 'ἀναγκάζω', 'αἱρέω', 'αἰσχύνομαι', 'ἀπαγγέλλω', 'ἀναμιμνῄσκω',
                             ...
                             'ἐκλέγω', 'ἐλπίζω', 'ἐνεδρεύω', 'ἐνορκίζω', 'ἐντέλλομαι', 'ἐξαιτέομαι', 'ἐξαπορέομαι',
                             'ἐξισχύω', 'ἐπαγγέλλομαι', 'ἐπαισχύνομαι', 'ἐπερωτάω', 'ἐπιδείκνυμι', 'ἐπιζητέω',
                             'ἐπιθυμέω', 'ἐπικρίνω', 'ἐπιλανθάνομαι', 'ἐπιμαρτυρέω', 'ἐπιποθέω', 'ἐπισκέπτομαι',
                             'ἐπιτάσσω', 'ἐπιτελέω', 'ἐπιτίθημι', 'ἐπιτρέπω', 'ἐπιχειρέω', 'ἐρωτάω', 'ἑτοιμάζω',
                             'εὐδοκέω', 'εὐκαιρέω', 'εὔχομαι', 'ἐφοράω', 'ζητέω', 'ἡγέομαι', 'θέλω', 'ἰσχύω',
                             'κατακρίνω', 'καταλαμβάνω', 'καταλείπω', 'κατανεύω', 'καταξιόω', 'καταπαύω', 'κατασείω',
                             'κατισχύω', 'κελεύω', 'κηρύσσω', 'κινδυνεύω', 'κρίνω', 'κωλύω', 'λαγχάνω', 'λέγω',
                             'λογίζομαι', 'μανθάνω', 'μαρτυρέω', 'μέλλω', 'νεύω', 'νοέω', 'νομίζω', 'οἶδα', 'οἶμαι',
                             'ὀκνέω', 'ὀμνύω', 'ὁμολογέω', 'ὁρίζω', 'ὀφείλω', 'παραγγέλλω', 'παραδίδωμι', 'παραινέω',
                             ...
                             'προστίθημι', 'προτίθεμαι', 'σημαίνω', 'σπουδάζω', 'συμβουλεύω', 'συνευδοκέω',
                             'συντίθημι', 'τάσσω', 'τολμάω', 'ὑποδείκνυμι', 'ὑποκρίνομαι', 'ὑπονοέω', 'φάσκω', 'φημί',
    ...
    def __init__(self, sbl_tree):
        ...
        for node_id, node in self.nodes.items():
            if node['tag'] == 'w':
                ...
                word_dict['lemma'] = word_dict['lemma'].replace('καταβιβάζω', 'καταβιβάζω')
    ...
    def __init__(self, uncut_sentence, root):
        ...
        for i, word in enumerate(self.words):
            ...
            if word['pos'] == 'verb':
                ...
                elif word['lemma'] in ['εἰμί', 'ἔξεστιν'] or word['lemma'].endswith('ειμι'):
