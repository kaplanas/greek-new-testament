...
SECOND_POSITION_CLITICS = ['ἄρα', 'γάρ', 'γε', 'δέ', 'μέν', 'μέντοι', 'οὖν', 'τε']
...
SENTENTIAL_CONJUNCTIONS = ['ἄρα', 'ἄχρι', 'διό', 'διότι', 'ἐάν', 'ἐάνπερ', 'εἰ', 'εἴπερ', 'ἐπάν', 'ἐπεί', 'ἐπειδή',
                           'ἕως', 'ἡνίκα', 'ἵνα', 'καθάπερ', 'καθό', 'καθότι', 'καθώς', 'κἄν', 'μέχρι', 'μήποτε', 'νή',
                           'ὁπότε', 'ὅπως', 'ὁσάκις', 'ὅταν', 'ὅτε', 'ὅτι', 'πρίν', 'ὥσπερ', 'ὥστε']
...
BURIED_CONJUNCTIONS = ['ἄχρι', 'διότι', 'ἐάν', 'ἐάνπερ', 'εἰ', 'εἴπερ', 'ἐπάν', 'ἐπεί', 'ἐπειδή', 'ἕως', 'ἡνίκα', 'ἵνα',
                       'καθάπερ', 'καθό', 'καθότι', 'καθώς', 'κἄν', 'μέχρι', 'μήποτε', 'νή', 'ὁπότε', 'ὅπως', 'ὁσάκις',
                       'ὅταν', 'ὅτε', 'πρίν', 'ὥσπερ', 'ὥστε']
ADVERB_CONJUNCTIONS = ['καί', 'μηδέ', 'μήτε', 'οὐδέ', 'οὔπω', 'οὔτε']
PARTITIVE_HEADS = ['δύο', 'εἷς', 'ἕκαστος', 'τίς', 'τις', 'οὐδείς', 'πᾶς']
PARTITIVE_PS = ['ἀπό', 'ἐκ', 'ἐν']
SENTENTIAL_COMPLEMENT_HEADS = ['ἀγνοέω', 'ἀκούω', 'ἀναγγέλλω', 'ἀναγινώσκω', 'ἀποκρίνω', 'ἀπολογέομαι', 'ἀρνέομαι',
                               'βοάω', 'γινώσκω', 'γνωρίζω', 'γνωστός', 'γράφω', 'δείκνυμι', 'δέω', 'δῆλος',
                               'διαλογίζομαι', 'διαμαρτύρομαι', 'διδάσκω', 'δοκέω', 'ἐλπίζω', 'ἐντέλλω',
                               'ἐξομολογέομαι', 'ἐπερωτάω', 'ἐπιγινώσκω', 'ἐπίσταμαι', 'ἐπιτάσσω', 'ἐρωτάω', 'θεάομαι',
                               'θέλω', 'θεωρέω', 'καταλαμβάνω', 'λαλέω', 'λέγω', 'λογίζομαι', 'μαρτυρέω', 'μαρτύρομαι',
                               'μιμνῄσκω', 'μνημονεύω', 'νοέω', 'νομίζω', 'οἶδα', 'οἶμαι', 'ὀμνύω', 'ὁμολογέω', 'ὁράω',
                               'πείθω', 'πιστεύω', 'πληροφορέω', 'πρόδηλος', 'προευαγγελίζομαι', 'προλέγω', 'προοράω',
                               'προφητεύω', 'συμβιβάζω', 'συμβουλεύω', 'συμμαρτυρέω', 'συνίημι', 'ὑποδείκνυμι',
                               'φανερόω', 'φημί']
INFINITIVE_ARGUMENT_HEADS = ['ἀγωνίζομαι', 'αἰτέω', 'ἀναγκάζω', 'αἱρέω', 'αἰσχύνω', 'ἀπαγγέλλω', 'ἀναμιμνῄσκω',
                             'ἀναπείθω', 'ἀξιόω', 'ἀπαρνέομαι', 'ἀπειλέω', 'ἀποκρίνω', 'ἀρνέομαι', 'ἄρχω', 'ἀφίημι',
                             'βοάω', 'βούλομαι', 'γινώσκω', 'δείκνυμι', 'δέω', 'δηλόω', 'διαμαρτύρομαι', 'διατάσσω',
                             'διδάσκω', 'διϊσχυρίζομαι', 'δοκέω', 'δύναμαι', 'δυνατέω', 'ἐάω', 'ἐγκόπτω', 'ἔθω',
                             'ἐκλέγω', 'ἐλπίζω', 'ἐνεδρεύω', 'ἐνορκίζομαι', 'ἐντέλλω', 'ἐξαιτέομαι', 'ἐξαπορέομαι',
                             'ἐξισχύω', 'ἐπαγγέλλω', 'ἐπαισχύνομαι', 'ἐπερωτάω', 'ἐπιδείκνυμι', 'ἐπιζητέω', 'ἐπιθυμέω',
                             'ἐπικρίνω', 'ἐπιλανθάνω', 'ἐπιμαρτυρέω', 'ἐπιποθέω', 'ἐπισκέπτομαι', 'ἐπιτάσσω',
                             'ἐπιτελέω', 'ἐπιτίθημι', 'ἐπιτρέπω', 'ἐπιχειρέω', 'ἐρωτάω', 'ἑτοιμάζω', 'εὐδοκέω',
                             'εὐκαιρέω', 'εὔχομαι', 'ἐφοράω', 'ζητέω', 'ἡγέομαι', 'θέλω', 'ἰσχύω', 'κατακρίνω',
                             ...
                             'παραιτέομαι', 'παρακαλέω', 'πείθω', 'πειράζω', 'πειράω', 'ποιέω', 'προαιτιάομαι',
                             'προμελετάω', 'προσδοκάω', 'προενάρχομαι', 'προσέχω', 'προσκαλέω', 'προστάσσω',
                             'προστίθημι', 'προτίθημι', 'σημαίνω', 'σπουδάζω', 'συμβουλεύω', 'συνευδοκέω',
                             'συντίθημι', 'τάσσω', 'τολμάω', 'ὑποδείκνυμι', 'ὑποκρίνω', 'ὑπονοέω', 'φάσκω', 'φημί',
                             'φιλέω', 'φιλοτιμέομαι', 'φοβέω', 'χαρίζω', 'χρηματίζω', 'χρονίζω']
...
FIRST_SECOND_DECLENSION = ['Ἀθῆναι', 'ἀλλήλων', 'ἀμφότεροι', 'διακόσιοι', 'δισχίλιοι', 'ἑαυτοῦ', 'ἐμαυτοῦ',
                           'ἑπτακισχίλιοι', 'ἔσω', 'Ἡρῳδιανοί', 'μύριοι', 'ὅδε', 'πεντακισχίλιοι', 'πεντακόσιοι',
                           'πορφυροῦς', 'σεαυτοῦ', 'σιδηροῦς', 'τετρακισχίλιοι', 'τετρακόσιοι', 'τετραπλοῦς', 'τοιόσδε',
...
SECOND_DECLENSION = ['ἀγενεαλόγητος', 'ἄγναφος', 'ἄγνωστος', 'ἀγοραῖος', 'ἀγράμματος', 'ἀδάπανος', 'ἄδηλος',
                     ...
                     'ἀκέραιος', 'ἄκρατος', 'ἀκρογωνιαῖος', 'ἀλάλητος', 'ἄλαλος', 'ἀλλόφυλος', 'ἄλογος', 'ἄλυπος',
                     ...
                     'ἄργυρος', 'ἄρρητος', 'ἄρρωστος', 'ἀρτιγέννητος', 'ἀσάλευτος', 'ἄσβεστος', 'ἄσημος', 'ἄσιτος',
                     ...
                     'βλητέος', 'βοηθός', 'βρώσιμος', 'Διάβολος', 'διάβολος', 'διάφορος', 'δίδραχμος', 'διθάλασσος',
                     'δίλογος', 'Διόσκουροι', 'δίστομος', 'δίψυχος', 'δόκιμος', 'δυσβάστακτος', 'δυσερμήνευτος',
                     'δύσκολος', 'δυσνόητος', 'ἔγγυος', 'ἐγκάθετος', 'ἐγκαίνια', 'ἔγκυος', 'εἰδωλόθυτος', 'εἰρηνοποιός',
                     'ἔκγονος', 'ἔκδηλος', 'ἔκδικος', 'ἔκδοτος', 'ἔκθαμβος', 'ἔκθετος', 'ἔκφοβος', 'ἔμφοβος', 'ἔμφυτος',
                     'ἔνδικος', 'ἔνδοξος', 'ἔννομος', 'ἔννυχος', 'ἔνοχος', 'ἔντιμος', 'ἐντόπιος', 'ἔντρομος',
                     'ἑξακόσιοι', 'ἔξυπνος', 'ἐπάρατος', 'ἐπίγειος', 'ἐπιθανάτιος', 'ἐπικατάρατος', 'ἐπίλοιπος',
                     'ἐπίορκος', 'ἐπιούσιος', 'ἐπιπόθητος', 'ἐπίσημος', 'ἐπουράνιος', 'ἔρημος', 'ἑτερόγλωσσος',
                     'εὐάρεστος', 'εὔθετος', 'εὔθυμος', 'εὔκαιρος', 'εὐκοπώτερος', 'εὐμετάδοτος', 'εὐπάρεδρος',
                     'εὐπερίστατος', 'εὐπρόσδεκτος', 'εὐρύχωρος', 'εὔσημος', 'εὔσπλαγχνος', 'εὔφημος', 'εὐχάριστος',
                     'εὔχρηστος', 'εὐώνυμος', 'ἐφήμερος', 'ἤρεμος', 'ἡσύχιος', 'θανατηφόρος', 'θεμέλιος', 'θεοδίδακτος',
                     'θεομάχος', 'θεόπνευστος', 'ἱερόθυτος', 'ἱερόσυλος', 'ἰσάγγελος', 'ἰσότιμος', 'ἰσόψυχος',
                     'κακοῦργος', 'καλοδιδάσκαλος', 'καρποφόρος', 'κατάδηλος', 'κατάλαλος', 'κατάλοιπος', 'καταχθόνιος',
                     'κατείδωλος', 'κενόδοξος', 'κεφάλαιος', 'κόσμιος', 'λιθόστρωτος', 'μακροχρόνιος', 'ματαιολόγος',
                     'μεμψίμοιρος', 'μέτοχος', 'μογιλάλος', 'μονόφθαλμος', 'νεόφυτος', 'νήπιος', 'νηφάλιος',
                     'οἰκουργός', 'ὀκταήμερος', 'ὀλιγόπιστος', 'ὀλιγόψυχος', 'ὁλόκληρος', 'ὁμότεχνος', 'ὀστράκινος',
                     'ὄψιμος', 'πανοῦργος', 'παράδοξος', 'παράλιος', 'παράσημος', 'παρείσακτος', 'παρεπίδημος',
                     'πάροικος', 'πάροινος', 'παρόμοιος', 'πατροπαράδοτος', 'περίεργος', 'περίλυπος', 'περίοικος',
                     'περιούσιος', 'περίχωρος', 'πολυποίκιλος', 'πολύσπλαγχνος', 'πολύτιμος', 'ποταμοφόρητος',
                     'Ποτίολοι', 'πρόγονος', 'πρόδηλος', 'πρόδρομος', 'πρόθυμος', 'πρόϊμος', 'πρόσκαιρος', 'πρόσπεινος',
                     'πρόσφατος', 'πρωϊνός', 'πρωτότοκος', 'σητόβρωτος', 'σκληροτράχηλος', 'σκυθρωπός', 'σκῦλα',
                     'σκωληκόβρωτος', 'σπερμολόγος', 'σπόριμος', 'στυγητός', 'συνεργός', 'συγκληρονόμος', 'σύζυγος',
                     'συμμέτοχος', 'σύμμορφος', 'σύμφορος', 'σύμφυτος', 'σύμφωνος', 'σύμψυχος', 'σύντροφος', 'σύσσωμος',
                     'σωτήριος', 'ταλαίπωρος', 'τετράγωνος', 'τετράμηνος', 'τρίμηνος', 'ὕπανδρος', 'ὑπέρακμος',
                     'ὑπερήφανος', 'ὑπέρογκος', 'ὑπήκοος', 'ὑπόδικος', 'φιλάγαθος', 'φιλάδελφος', 'φίλανδρος',
                     'φιλάργυρος', 'φίλαυτος', 'φιλήδονος', 'Φίλιπποι', 'φιλόθεος', 'φιλόνεικος', 'φιλόξενος',
                     'φιλόστοργος', 'φιλότεκνος', 'φλύαρος', 'φρόνιμος', 'φωσφόρος', 'χειροποίητος', 'χρυσοδακτύλιος',
...
THIRD_DECLENSION_CONSONANT_STEM = ['ἅλας', 'ἄρσην', 'γάλα', 'γέλως', 'γόης', 'Δάμαρις', 'δεκατέσσαρες', 'δισμυριάς',
                                   ...
                                   'παῖς', 'πέρας', 'πετρώδης', 'πλήρης', 'ποιμήν', 'Πούδης', 'πρεσβῦτις', 'προφῆτις',
    ...
    def __init__(self, uncut_sentence, root):
        ...
        for i, word in enumerate(self.words):
            ...
            if word['head'] is not None:
                ...
                if word['lemma'] in SECOND_POSITION_CLITICS and word['id'] > head['id']:
                    ...
                    if word_features['pos'] in ['noun', 'adj', 'num', 'personal pronoun', 'indefinite pronoun',
                        ...
                        (word_head_features['voice'] != 'passive' or head['lemma'] == 'ἀποκρίνω') and \
                    ...
                    if word['lemma'] in ['ὅς', 'ὅστις'] and i > 0 and \
                            self.words[i - 1]['lemma'] in ['ἕως', 'μέχρι', 'ἄχρι', 'ἄχρις']:
                        ...
                        word['relation'] = 'argument of adjective, nominal'
                                           ...
                                           'κύριος', 'λαός', 'μαθητής', 'μήτηρ', 'παῖς', 'πατήρ', 'πλήσιος', 'σπέρμα',
                    ...
                    if head['lemma'] in ['ἀκολουθέω', 'ἀνθίστημι', 'ἀντίκειμαι', 'ἀπειθέω', 'ἀποτάσσω', 'ἀρέσκω',
                                         'ἀτενίζω', 'βοηθέω', 'διακονέω', 'δοκέω', 'δουλεύω', 'ἐγγίζω', 'ἐμβλέπω',
                                         'ἐμπαίζω', 'ἐξακολουθέω', 'ἐξομολογέομαι', 'ἔοικα', 'ἐπακολουθέω', 'ἐπιμένω',
                                         'ἐπισκιάζω', 'ἐπιτιμάω', 'εὐχαριστέω', 'ἐφίστημι', 'λατρεύω', 'μέλω',
                    ...
                    word['relation'] = 'direct object'
                        ...
                        ((head['lemma'] == 'γίνομαι' and head['voice'] == 'middle') or
                         ...
                         (head['lemma'] == 'μέλω' and head['voice'] == 'active')):
                    word['relation'] = 'subject'
                elif word_head_features['degree'] == 'comparative':
                    word['relation'] = 'comparative'
            ...
            if word['pos'] == 'verb':
                ...
                elif word['lemma'] in ['εἰμί', 'ἔξεστι'] or word['lemma'].endswith('ειμι'):
