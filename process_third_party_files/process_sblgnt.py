...
INDIVIDUAL_LEMMA_EDITS = pd.read_csv(SBL_DIR + '/individual_lemma_edits.csv',
                                     dtype=defaultdict(lambda: str,
...
SECOND_DECLENSION = ['ἀγενεαλόγητος', 'ἄγναφος', 'ἄγνωστος', 'ἀγοραῖος', 'ἀγράμματος', 'ἀδάπανος', 'ἄδηλος',
                     ...
                     'οὐράνιος', 'ὄψιμος', 'πανοῦργος', 'παράδοξος', 'παράλιος', 'παράσημος', 'παρείσακτος',
                     ...
                     'σύμψυχος', 'σύντροφος', 'σύσσωμος', 'σωτήριος', 'ταλαίπωρος', 'τετράγωνος', 'τετράμηνος',
                     'τρίμηνος', 'ὕπανδρος', 'ὑπέρακμος', 'ὑπερήφανος', 'ὑπέρογκος', 'ὑπήκοος', 'ὑπόδικος', 'φιλάγαθος',
                     ...
                     'χειροποίητος', 'χρυσοδακτύλιος', 'ψευδολόγος', 'ψευδώνυμος', 'ὠφέλιμος']
...
class UncutSentence:
    ...
    def __init__(self, sbl_tree):
        ...
        edits_df = edits_df.merge(INDIVIDUAL_LEMMA_EDITS, left_on=['book', 'chapter', 'verse', 'position'],
            ...
            for word in self.words:
                if (word['book'], word['chapter'], word['verse'], word['position']) in edit_targets:
                    edit_index = edit_targets.index((word['book'], word['chapter'], word['verse'],
                                                     word['position']))
                    word['lemma'] = edits_df['new_lemma'][edit_index]
